...
void main() {
	...
	`}var yo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new hi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Ll=class extends Dl{constructor(){super(),this.isOutputPass=!0,this.uniforms=ji.clone(Il.uniforms),this.material=new Fi({name:Il.name,uniforms:this.uniforms,vertexShader:Il.vertexShader,fragmentShader:Il.fragmentShader}),this._fsQuad=new Al(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},J.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Rl={meta:{n:54,n_chapters:4},students:[{id:1,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`C#/.NET`,`Cloud`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`migrar`,tem_ingles:0},{id:2,bg:`nula`,emp:`empregado`,foco:`Full-stack`,sen:0,stacks:[`Python`],n_stacks:1,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:0,obj:`promocao`,tem_ingles:0},{id:3,bg:`nula`,emp:`empregado`,foco:`Mobile`,sen:0,stacks:[`Python`],n_stacks:1,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`migrar`,tem_ingles:1},{id:4,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`Java`,`Cloud`,`Go`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:5,bg:`nula`,emp:`desempregado`,foco:`QA`,sen:1,stacks:[`Java`,`Python`],n_stacks:2,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:6,bg:`autodidata`,emp:`ex_empregado`,foco:`Back-end`,sen:0,stacks:[`C#/.NET`,`Java`],n_stacks:2,ia_pos:0,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`empreender`,tem_ingles:0},{id:7,bg:`nula`,emp:`ex_empregado`,foco:`Full-stack`,sen:0,stacks:[`JS/TS`,`SQL/BD`],n_stacks:2,ia_pos:1,fear_subst:0,fear_stag:1,quer_exterior:0,obj:`migrar`,tem_ingles:0},{id:8,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`JS/TS`,`PHP`,`SQL/BD`,`Python`],n_stacks:4,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:9,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`JS/TS`],n_stacks:1,ia_pos:1,fear_subst:0,fear_stag:1,quer_exterior:1,obj:`migrar`,tem_ingles:1},{id:10,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:0,stacks:[`JS/TS`,`SQL/BD`,`Python`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:11,bg:`autodidata`,emp:`desempregado`,foco:`Full-stack`,sen:0,stacks:[`JS/TS`,`SQL/BD`,`Java`,`Python`],n_stacks:4,ia_pos:0,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`primeiro_emprego`,tem_ingles:1},{id:12,bg:`profissional`,emp:`empregado`,foco:`Back-end`,sen:0,stacks:[`C#/.NET`,`SQL/BD`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:0,obj:`empreender`,tem_ingles:0},{id:13,bg:`outro`,emp:`ex_empregado`,foco:`Back-end`,sen:1,stacks:[`Cloud`,`SQL/BD`,`Python`],n_stacks:3,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:0,obj:`migrar`,tem_ingles:1},{id:14,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:0,stacks:[`C#/.NET`,`Java`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`promocao`,tem_ingles:0},{id:15,bg:`nula`,emp:`desempregado`,foco:`QA`,sen:0,stacks:[`Java`,`Python`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:16,bg:`nula`,emp:`ex_empregado`,foco:`Back-end`,sen:1,stacks:[`Java`,`JS/TS`,`C#/.NET`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:17,bg:`autodidata`,emp:`ex_empregado`,foco:`Back-end`,sen:0,stacks:[`Java`,`Cloud`,`JS/TS`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:18,bg:`outro`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`JS/TS`,`SQL/BD`,`Python`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:0},{id:19,bg:`nula`,emp:`empregado`,foco:`Full-stack`,sen:1,stacks:[`JS/TS`,`C#/.NET`,`SQL/BD`,`Python`],n_stacks:4,ia_pos:1,fear_subst:0,fear_stag:1,quer_exterior:1,obj:`migrar`,tem_ingles:1},{id:20,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`Java`,`Cloud`,`JS/TS`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`migrar`,tem_ingles:1},{id:21,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`Go`,`Cloud`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:0,obj:`promocao`,tem_ingles:1},{id:22,bg:`nula`,emp:`desempregado`,foco:`Back-end`,sen:0,stacks:[`JS/TS`,`Cloud`,`SQL/BD`,`Python`],n_stacks:4,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:23,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`Cloud`,`SQL/BD`,`Java`,`Python`],n_stacks:4,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`outro`,tem_ingles:1},{id:24,bg:`nula`,emp:`empregado`,foco:`Dados`,sen:1,stacks:[`Java`,`JS/TS`,`SQL/BD`,`Python`,`BI`],n_stacks:5,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:25,bg:`profissional`,emp:`ex_empregado`,foco:`Full-stack`,sen:0,stacks:[`Java`,`C/C++`,`JS/TS`,`C#/.NET`,`Python`],n_stacks:5,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:0,obj:`empreender`,tem_ingles:1},{id:26,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`Java`,`Apex`,`Cloud`,`JS/TS`,`Go`,`SQL/BD`],n_stacks:6,ia_pos:0,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:27,bg:`autodidata`,emp:`ex_empregado`,foco:`Outro`,sen:1,stacks:[`Java`,`JS/TS`,`C#/.NET`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:28,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`Java`,`Cloud`,`JS/TS`,`C#/.NET`,`SQL/BD`],n_stacks:5,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:29,bg:`nula`,emp:`ex_empregado`,foco:`Back-end`,sen:0,stacks:[`JS/TS`,`Python`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:0,obj:`empreender`,tem_ingles:1},{id:30,bg:`profissional`,emp:`empregado`,foco:`Full-stack`,sen:2,stacks:[`Java`,`JS/TS`,`C#/.NET`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:0,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:31,bg:`nula`,emp:`empregado`,foco:`Mobile`,sen:1,stacks:[`Java`,`Cloud`,`JS/TS`,`Swift`,`SQL/BD`,`Python`,`Kotlin/Swift`],n_stacks:7,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:32,bg:`outro`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`JS/TS`,`SQL/BD`,`Java`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:33,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`JS/TS`,`SQL/BD`,`Java`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:34,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`JS/TS`,`Cloud`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:0,obj:`migrar`,tem_ingles:0},{id:35,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`Java`],n_stacks:1,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`promocao`,tem_ingles:0},{id:36,bg:`profissional`,emp:`empregado`,foco:`Back-end`,sen:3,stacks:[`SQL/BD`,`Ruby`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`estavel`,tem_ingles:1},{id:37,bg:`nula`,emp:`empregado`,foco:`Full-stack`,sen:2,stacks:[`IA/Prompts`,`SQL/BD`,`Python`,`Kotlin/Swift`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:0,obj:`empreender`,tem_ingles:1},{id:38,bg:`autodidata`,emp:`empregado`,foco:`Full-stack`,sen:2,stacks:[`JS/TS`,`SQL/BD`,`Kotlin/Swift`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`promocao`,tem_ingles:0},{id:39,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`Python`],n_stacks:1,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:40,bg:`nula`,emp:`empregado`,foco:`Full-stack`,sen:1,stacks:[`SQL/BD`,`PHP`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:41,bg:`nula`,emp:`empregado`,foco:`Mobile`,sen:3,stacks:[`Java`,`Kotlin/Swift`],n_stacks:2,ia_pos:0,fear_subst:1,fear_stag:1,quer_exterior:0,obj:`promocao`,tem_ingles:1},{id:42,bg:`nula`,emp:`empregado`,foco:`Outro`,sen:1,stacks:[`JS/TS`,`SQL/BD`,`Java`,`Python`],n_stacks:4,ia_pos:1,fear_subst:0,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:43,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`JS/TS`,`C#/.NET`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:0,obj:`migrar`,tem_ingles:1},{id:44,bg:`profissional`,emp:`empregado`,foco:`Back-end`,sen:3,stacks:[`Go`,`Java`],n_stacks:2,ia_pos:0,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:45,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`Python`,`Kotlin/Swift`],n_stacks:2,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:0,obj:`promocao`,tem_ingles:1},{id:46,bg:`profissional`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`Java`,`Cloud`,`JS/TS`,`SQL/BD`,`Python`],n_stacks:5,ia_pos:1,fear_subst:0,fear_stag:1,quer_exterior:0,obj:`migrar`,tem_ingles:1},{id:47,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`JS/TS`,`Cloud`,`SQL/BD`,`Python`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`promocao`,tem_ingles:1},{id:48,bg:`autodidata`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`JS/TS`,`C#/.NET`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:49,bg:`autodidata`,emp:`empregado`,foco:`Full-stack`,sen:2,stacks:[`JS/TS`,`Java`,`Kotlin/Swift`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:1,obj:`exterior`,tem_ingles:0},{id:50,bg:`nula`,emp:`empregado`,foco:`Back-end`,sen:1,stacks:[`JS/TS`,`SQL/BD`,`Java`,`Python`],n_stacks:4,ia_pos:1,fear_subst:0,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:51,bg:`autodidata`,emp:`empregado`,foco:`Full-stack`,sen:2,stacks:[`JS/TS`,`Cloud`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`exterior`,tem_ingles:1},{id:52,bg:`nula`,emp:`empregado`,foco:`Outro`,sen:0,stacks:[`JS/TS`,`Java`,`Python`],n_stacks:3,ia_pos:1,fear_subst:1,fear_stag:0,quer_exterior:0,obj:`empreender`,tem_ingles:1},{id:53,bg:`profissional`,emp:`empregado`,foco:`Back-end`,sen:2,stacks:[`C#/.NET`,`Cloud`,`SQL/BD`,`Java`],n_stacks:4,ia_pos:1,fear_subst:0,fear_stag:1,quer_exterior:1,obj:`promocao`,tem_ingles:1},{id:54,bg:`autodidata`,emp:`empregado`,foco:`Full-stack`,sen:1,stacks:[`JS/TS`,`SQL/BD`,`Java`,`Python`],n_stacks:4,ia_pos:1,fear_subst:1,fear_stag:1,quer_exterior:1,obj:`migrar`,tem_ingles:1}],skill_nodes:[{id:`JS/TS`,x:3,y:0,z:1,freq:33},{id:`Python`,x:-1,y:0,z:4,freq:31},{id:`Java`,x:-3,y:0,z:-2,freq:35},{id:`SQL/BD`,x:2,y:0,z:-3,freq:38},{id:`C#/.NET`,x:0,y:.5,z:-1,freq:13},{id:`Cloud`,x:1,y:-.5,z:2,freq:16},{id:`Kotlin/Swift`,x:-2,y:1,z:1,freq:6},{id:`Go`,x:4,y:0,z:-1,freq:4}],skill_links:[{source:`C#/.NET`,target:`Cloud`,value:3},{source:`C#/.NET`,target:`SQL/BD`,value:10},{source:`C#/.NET`,target:`Java`,value:11},{source:`Cloud`,target:`SQL/BD`,value:16},{source:`Cloud`,target:`Java`,value:13},{source:`Java`,target:`SQL/BD`,value:25},{source:`Java`,target:`Python`,value:18},{source:`Cloud`,target:`Go`,value:3},{source:`Cloud`,target:`Python`,value:9},{source:`Go`,target:`Java`,value:4},{source:`Go`,target:`SQL/BD`,value:3},{source:`Python`,target:`SQL/BD`,value:22},{source:`JS/TS`,target:`SQL/BD`,value:28},{source:`JS/TS`,target:`Python`,value:21},{source:`PHP`,target:`SQL/BD`,value:2},{source:`JS/TS`,target:`Java`,value:23},{source:`C#/.NET`,target:`JS/TS`,value:8},{source:`C#/.NET`,target:`Python`,value:5},{source:`Cloud`,target:`JS/TS`,value:10},{source:`Java`,target:`Kotlin/Swift`,value:3},{source:`JS/TS`,target:`Kotlin/Swift`,value:3},{source:`Kotlin/Swift`,target:`SQL/BD`,value:3},{source:`Kotlin/Swift`,target:`Python`,value:3}],morph_targets:{origem:[[-.9472561026402972,.08512963709904448,-1.1469236955576623],[-1.8523093573218432,-.16927300100229467,-2.601697152357267],[-.326222059339345,.05395839760062835,1.4715479938234401],[-1.1750497626377667,-.17766044651589805,.08438290554398603],[.5733098825989281,.1645967059944412,-2.738836766861457],[5.1319245275761824,.5477598362280098,3.7232786799490927],[-1.171619530514302,.03734137129208078,1.4579223863915496],[5.121802746801459,.44033409709777455,3.8353883816438588],[.9088304903266826,-.04372762420499275,-1.5677367709514138],[4.687832198823926,.44648837088796584,3.258616202377791],[3.797115691423327,.4889318633889277,3.4568501132202023],[-3.144479106688007,-.5398551254383265,-4.016572824908406],[2.715448043643099,.08365607907473024,-1.9007192139229263],[5.425541320337631,.4728871459473289,3.748046653815346],[-2.3240005913642614,.027846772292434336,-.30593108159630544],[-.6886649004252239,-.1512748883074941,-1.2718414076505615],[6.082326150968693,.4454246042050303,2.9795541592725883],[2.655557330897094,-.2849935468663998,-2.8548896462598594],[-.21302424919083973,-.04866041557076967,1.3091348262862115],[-1.26791233698174,.05329273868877368,1.6307305449588712],[5.198086893133374,.45971130336102456,3.5789299520707902],[-.6310560295540624,-.0433960409672468,-1.302352145856669],[5.786940942754282,.5517874976365396,3.8043554706703873],[2.324564064165685,.12342669126833145,.12931288476571773],[-4.4638567359654955,-.4585298987052995,-4.6003262921165575],[5.7668605791723735,.4470529062164036,3.0728015814478],[5.942749537878871,.5442795676783967,2.81396556573312],[5.146641723049398,.4952515521972812,3.4524139628456627],[-.4772483116235606,-.08361328464874701,-1.6394347801509233],[-3.490897461809284,-.5238316494499162,-3.645926105353784],[1.2635651956609955,.05595791950615682,2.5160131858651607],[-3.6522051118094327,-.13498240897852845,-3.7630788020079806],[-2.2972399939323385,-.09121409723016596,1.3671929900260076],[-1.2182870047906758,-.036215818149456985,.05072338843438384],[.5880142088634361,-.16303810484709558,2.32572467313231],[-3.3441491305828297,-.48925566407011073,-3.185494456292543],[2.149949664545608,-.15713002578529545,1.2930443385311063],[5.23565453211245,.48597746462272673,1.5316864617931545],[4.078029594331892,.492600350887971,3.8991954520081666],[-2.15802118739379,.1298806928044193,2.7323877819844364],[2.679804366734525,-.0839429316170846,.2294092619073734],[-.8155617200960177,.16337373390758886,-.9477297002180078],[4.145028357728281,.4918108272876978,3.68858422865946],[-4.729436837868986,-.5266166720518817,-3.325924640886743],[1.033879884611097,.1485460221641354,-1.5040097317415169],[-4.180697474786471,-.5180002628181114,-4.444883741676338],[5.302331159286971,.548387972251513,2.6130424843836546],[6.674733200418691,.49793232206490345,2.4576560758390014],[4.843616466813822,.5698844735042805,3.751770100484775],[1.2571663353620401,-.12497786332213145,-.9460747267971309],[4.842563811002349,.565853740283793,4.205875373644469],[.5775607159910463,-.17979411739394036,-1.9808885046462736],[-4.65699267246884,-.4551391003231002,-3.11795185679051],[6.207855939776109,.4707259268712172,2.694116372898181]],stacks:[[.4934,.6083,-1.0484],[-.4777,.0834,3.4453],[-1.1013,-.123,3.4429],[-2.7505,-.0914,-2.4357],[-2.6526,.0262,-1.7333],[-.0611,.4971,-1.4289],[3.5377,-.0558,.5834],[3.9059,.0603,.984],[2.3447,.0958,.7404],[3.5218,-.088,.6872],[3.376,.0902,1.3704],[.2885,.57,-1.2999],[1.4684,-.3925,1.5468],[.5663,.3812,-1.5352],[-2.9747,.091,-2.4191],[-2.7582,.093,-2.5538],[-2.6932,-.0487,-2.3251],[3.073,-.0429,.4609],[3.5484,-.0251,.3562],[-2.2707,.1176,-2.1366],[4.3906,-.0164,-.1747],[2.9545,-.0287,.549],[.4752,-.3936,1.6349],[-3.7014,-.0339,-2.1562],[-2.4535,.087,-1.7589],[-3.1514,-.0244,-2.6522],[-3.1431,.0443,-1.4892],[-2.3681,-.1249,-2.456],[2.8936,-.0088,1.5244],[-3.5712,.074,-1.7241],[-2.7838,-.0412,-1.5928],[3.3909,-.0752,.1628],[3.6114,-.1068,1.1476],[2.2542,-.0014,1.4467],[-3.0467,.0675,-1.2348],[2.5884,.0045,-2.4269],[.646,.0754,.1873],[2.5223,.0979,.2039],[-1.6524,.012,3.4907],[2.6126,-.0632,-3.5007],[-3.6344,-.0564,-2.729],[3.4455,.01,1.2269],[3.3618,-.1089,1.4249],[3.2588,-.02,-.5661],[-.3987,.0664,3.6639],[-3.3897,.0884,-1.6186],[3.7165,.0258,.8023],[3.0842,-.041,1.4304],[2.6474,-.0931,.3614],[2.6867,-.1182,.7224],[2.6399,-.0302,.4888],[3.1497,.063,1.4319],[.2455,.5099,-1.6171],[3.5975,.0379,1.0419]],ia:[[.0134,.6232,-.5052],[.7736,-.9076,1.099],[.376,.4908,1.8425],[-.8602,.3771,-.6869],[.595,-.4619,-.1341],[-.2929,.9124,-.5964],[3.1377,.8741,1.6236],[.1795,.7511,-1.2624],[2.8717,1.1868,-.2925],[-1.1109,.0116,1.1745],[.6695,-1.1748,-1.3703],[.7443,.4287,-1.3804],[3.6628,-1.1653,-.8073],[-1.9994,-.1567,.2081],[.5567,.4939,-.7491],[.0723,-.0796,1.8731],[.8313,.4996,.1516],[.6679,-.4562,-2.1551],[-.1416,-2.5263,.8499],[-.7838,-.0575,-4.1194],[-1.2576,-.0228,-1.6404],[.2433,.3415,1.3485],[-3.6528,.1377,.6195],[-.5917,.3242,1.0638],[.6815,-.439,.6453],[.1379,-.8765,-1.7969],[-.0828,.9848,-.5139],[2.0717,-1.1911,1.5157],[1.544,.0636,.1376],[-1.1278,.308,-.393],[-2.5634,1.7228,.1471],[-.8731,-.4581,.3427],[-1.1158,.5695,.1572],[-.3846,-.6656,-.4067],[-.0649,.745,.1844],[-.8592,.4694,-.678],[-2.3051,-.1675,.7407],[-.6572,.2885,1.8119],[2.5836,-1.1798,-.8829],[.4026,-.3771,.6092],[-1.2683,.1527,.4077],[-.9125,.9103,-3.2913],[1.4418,.6859,-.7471],[1.6826,-.1672,-.7449],[.6396,.3947,-.4149],[-1.1641,1.1324,3.0741],[1.4349,.4941,1.4233],[-.9825,-.0073,-.0029],[-1.066,-.2671,.4851],[2.8767,1.6118,-.7019],[1.1888,.2618,-.0032],[.0826,-.0744,-2.0968],[1.624,.4044,3.5367],[1.2413,-.283,.8014]],fuga_base:[[2.8619,-1.9419,-1.3616],[.4008,-2.0556,-.3614],[.1168,-1.9527,3.905],[-1.1058,-1.9624,2.0515],[3.4214,-1.9405,-.4951],[-2.0856,-1.9847,-2.733],[3.3034,-2.1148,-.3084],[.071,-1.8996,-1.8126],[-.9313,-1.9975,3.3749],[2.32,-1.8697,-.6805],[-1.6116,-1.8503,.6955],[-1.239,-1.987,.4153],[1.58,-2.0799,.5744],[1.6418,-2.0342,2.4913],[-.0374,-1.9993,-3.7038],[-.4776,-2.0129,.2076],[-2.7651,-1.8592,-.2441],[2.8141,-1.8922,2.8187],[2.0752,-2.1392,2.9791],[3.9794,-2.0198,1.9741],[-.4506,-1.879,1.552],[-1.0013,-1.9907,-2.8354],[-3.3683,-1.9641,2.9667],[-.3108,-2.0734,-1.9682],[1.4209,-2.0175,-2.7362],[-.6055,-1.8964,-1.9992],[-2.1024,-1.9776,.5754],[1.2658,-1.9802,-1.8042],[.8513,-1.8788,-.0262],[-1.1814,-1.9637,1.0929],[2.7067,-1.879,1.026],[.6366,-2.123,1.8589],[-2.9427,-1.8586,.3153],[-1.9442,-2.0054,2.5975],[-3.0786,-2.1078,3.7031],[3.8395,-1.9086,3.7382],[.2926,-1.9482,-.3617],[3.5223,-2.0799,-3.1332],[3.322,-2.131,-2.2291],[-.7336,-1.8661,-2.8818],[3.0981,-2.0139,-2.9147],[-.647,-2.1036,1.9382],[-.7351,-2.1402,3.6122],[2.8436,-1.9443,-3.2052],[-.8149,-2.1134,-2.4815],[1.1336,-2.1436,.7772],[.5166,-1.9205,-3.4511],[-1.3715,-1.8798,-2.8196],[-2.9601,-2.0977,-1.9948],[2.3199,-2.0529,-2.0965],[.2087,-2.0071,1.9653],[.0307,-2.137,3.5633],[-.3357,-2.1318,3.7122],[-.0778,-2.128,3.2776]],fuga_alvo:[[-.2541,1.5941,.5342],[-.2121,.4713,-2.4358],[.0511,1.4063,-.1041],[.312,4.5148,3.1443],[-.4543,4.5327,4.0678],[-2.4373,3.1477,-.4881],[.3986,1.565,-.0019],[.5763,4.5154,3.1925],[.4552,1.4329,.4368],[.0093,4.4349,3.8847],[1.9876,.0116,-2.4217],[-2.5536,2.9066,-.2139],[.3307,1.5734,-.5476],[.1964,.6442,-2.6151],[.1082,4.6123,3.9436],[.2669,4.5464,3.392],[-.1937,4.545,3.7312],[-.144,2.5656,3.28],[-.5179,1.6263,.1574],[-.4819,1.6118,.1605],[-.5448,.438,-2.6446],[.0791,4.401,3.851],[2.689,1.8929,-.5046],[-.5887,4.6204,3.8656],[-2.6853,3.0417,.1051],[-.3609,4.495,3.3616],[.5912,4.6434,3.2543],[.223,4.3647,3.7936],[-2.7566,3.0321,.3586],[.2133,4.5478,3.7651],[.1756,4.4822,3.2707],[-.2459,4.4027,3.797],[.037,4.5991,3.9962],[.3678,1.4516,.2959],[.5598,.5673,-2.5678],[-.1611,-.1458,.3488],[-2.2932,3.0967,.1015],[-.57,.5184,-2.5389],[.3886,4.4407,3.9913],[-.2348,4.3792,3.4911],[.2046,.6338,-2.7082],[-.1021,4.4968,3.0188],[-.1554,1.6352,-.0679],[.0534,4.4576,4.0734],[.4176,.5488,-3.0543],[.3442,1.3878,-.3077],[-.3514,.6109,-3.3409],[-.5966,4.3934,3.9301],[.1933,2.3545,2.9309],[-.3909,4.5725,2.9629],[.3336,4.3827,3.5159],[-2.1601,3.0064,.4404],[-.0252,.5558,-3.1181],[-.5031,1.3697,.13]]},chapters:{origem:{title:`A Origem`,n_nula:25,n_auto:19,n_prof:7,n_empregados:42},stacks:{title:`As Stacks`,planets:[`JS/TS`,`Python`,`Java`,`SQL/BD`,`C#/.NET`,`Cloud`,`Kotlin/Swift`,`Go`],n_links:23,media_stacks:3.4,top_stack:`SQL/BD`},ia:{title:`O Paradoxo da IA`,n_positivo:42,n_fear_subst:40,n_fear_stag:22},fuga:{title:`A Rota de Fuga`,n_exterior:40,n_ingles:43,objetivos:{migrar:11,promocao:9,exterior:25,empreender:6,primeiro_emprego:1,outro:1,estavel:1}}}}.students,zl=Rl.length,Bl=11,Vl=[`BOOT`,`A METODOLOGIA`,`FRAMEWORK G.Q.M.`,`A ORIGEM`,`MERCADO`,`AS STACKS`,`O GAP`,`MÉTRICAS`,`PARADOXO DA IA`,`ROTA DE FUGA`,`SÍNTESE`],Hl={"Back-end":1125327,"Full-stack":7424286,"Front-end":3735259,Mobile:15760653,Dados:1146669,Pesquisa:16119127,QA:15553722,Gestao:7024571,Outro:12914961};function Ul(e){return Hl[e]||16777215}function Wl(){let e=[],t={};Rl.forEach((e,n)=>{t[e.foco]||(t[e.foco]=[]),t[e.foco].push(n)});let n=Object.keys(t),r=0;return n.forEach(n=>{let i=t[n];i.sort((e,t)=>Rl[e].sen-Rl[t].sen);let a=i.length/zl*Math.PI*2,o=r;i.forEach((t,n)=>{let r=4.5+n/i.length*16+Math.random()*1.5,s=o+Math.random()*a*.7+a*.15;e[t]=[Math.cos(s)*r,0,Math.sin(s)*r]}),r+=a}),e}var Gl=Wl(),Kl=new Nn;Kl.background=new Y(132362),Kl.fog=new Mn(132362,.015);var ql=new ma(50,innerWidth/innerHeight,.1,300);ql.position.set(0,35,5);var Jl=/iPhone|iPad|iPod|Android/i.test(navigator.userAgent)||innerWidth<=768,Yl=new rl({antialias:!Jl,powerPreference:`high-performance`});Yl.setSize(innerWidth,innerHeight),Yl.setPixelRatio(Math.min(devicePixelRatio,Jl?1.5:2)),Yl.shadowMap.enabled=!Jl,Yl.shadowMap.type=2,document.getElementById(`scene`).appendChild(Yl.domElement);var Xl=new pl(ql,Yl.domElement);Xl.enableDamping=!0,Xl.dampingFactor=.05,Xl.minDistance=2,Xl.maxDistance=100,Xl.target.set(0,0,0),Xl.enabled=!1;var Zl=new Pl(Yl);Zl.addPass(new Fl(Kl,ql)),Zl.addPass(new Ll);var Ql=new xi(.35,.4,16,16),$l=new xi(.12,.25,12,16),eu=new bi(.4,.55,.25,4,4,4),tu=new xi(.18,.28,16,16);function nu(e){let t=new wn,n=new Ii({color:e,roughness:.7,metalness:.1}),r=new Ii({color:8965375,roughness:.1,metalness:.8}),i=new Xr(Ql,n);i.position.y=.7,i.castShadow=!0,i.receiveShadow=!0,t.add(i);let a=new Xr($l,n);a.position.set(-.15,.2,0),a.castShadow=!0;let o=new Xr($l,n);o.position.set(.15,.2,0),o.castShadow=!0,t.add(a,o);let s=new Xr(eu,n);s.position.set(0,.65,-.3),s.castShadow=!0,t.add(s);let c=new Xr(tu,r);return c.rotation.z=Math.PI/2,c.position.set(0,.85,.32),c.scale.set(1,1,.4),c.castShadow=!0,t.add(c),{group:t,materials:[n,r],suitMat:n,visorMat:r,legL:a,legR:o,body:i}}var ru=new wn;Kl.add(ru);var iu=[];for(let e=0;e<zl;e++){let t=Rl[e],n=Ul(t.foco),r=nu(n),i=.8+t.sen*.2;r.group.scale.set(i,i,i);let[a,o,s]=Gl[e];r.group.position.set(a,o-10,s),r.group.lookAt(0,r.group.position.y,0),ru.add(r.group),iu.push({group:r.group,suitMat:r.suitMat,visorMat:r.visorMat,legL:r.legL,legR:r.legR,bodyMesh:r.body,idx:e,baseX:a,baseY:o,baseZ:s,baseHex:n,baseScale:i,bobPhase:Math.random()*Math.PI*2,bobSpeed:1.5+Math.random()*1.5,match:!0,isMetricsUser:e%2!=0&&e%3!=0})}var au=iu.filter(e=>e.isMetricsUser).length;au>23&&iu.forEach(e=>{e.isMetricsUser&&au>23&&(e.isMetricsUser=!1,au--)}),au<23&&iu.forEach(e=>{!e.isMetricsUser&&au<23&&(e.isMetricsUser=!0,au++)});var ou=[`hyper`,`chill`,`nervous`,`curious`,`proud`];iu.forEach((e,t)=>{e.personality=ou[t%ou.length],e.bobAmp=.12+Math.random()*.55,e.bobFreq=.5+Math.random()*1.8,e.swayAmp=.04+Math.random()*.12,e.lifeTimer=null,e.wanderTimer=null,e.wanderMoveTween=null,e.wanderLegL=null,e.wanderLegR=null});function su(){let e=1024,t=document.createElement(`canvas`);t.width=e,t.height=e;let r=t.getContext(`2d`);r.fillStyle=`#475569`,r.fillRect(0,0,e,e);for(let e=0;e<8;e++)for(let t=0;t<8;t++){let n=e*128,i=t*128,a=r.createRadialGradient(n+128/2,i+128/2,0,n+128/2,i+128/2,128);a.addColorStop(0,`#64748b`),a.addColorStop(1,`#475569`),r.fillStyle=a,r.fillRect(n+4,i+4,120,120),r.fillStyle=`#1e293b`,r.beginPath(),r.arc(n+16,i+16,4,0,Math.PI*2),r.fill(),r.beginPath(),r.arc(n+128-16,i+16,4,0,Math.PI*2),r.fill(),r.beginPath(),r.arc(n+16,i+128-16,4,0,Math.PI*2),r.fill(),r.beginPath(),r.arc(n+128-16,i+128-16,4,0,Math.PI*2),r.fill()}let i=r.getImageData(0,0,e,e),a=i.data;for(let e=0;e<a.length;e+=4){let t=(Math.random()-.5)*15;a[e]=Math.min(255,Math.max(0,a[e]+t)),a[e+1]=Math.min(255,Math.max(0,a[e+1]+t)),a[e+2]=Math.min(255,Math.max(0,a[e+2]+t))}r.putImageData(i,0,0);let o=new gi(t);return o.wrapS=n,o.wrapT=n,o.repeat.set(8,8),o.anisotropy=Yl.capabilities.getMaxAnisotropy(),o}function cu(){let e=document.createElement(`canvas`);e.width=256,e.height=256;let t=e.getContext(`2d`);t.fillStyle=`#0f172a`,t.fillRect(0,0,256,256),t.strokeStyle=`#334155`,t.lineWidth=8;for(let e=0;e<256;e+=24)t.beginPath(),t.moveTo(e,0),t.lineTo(e,256),t.stroke(),t.beginPath(),t.moveTo(0,e),t.lineTo(256,e),t.stroke();let r=new gi(e);return r.wrapS=n,r.wrapT=n,r.repeat.set(6,6),r.anisotropy=Yl.capabilities.getMaxAnisotropy(),r}var lu=26,uu=su(),du=cu(),fu=new Xr(new Si(lu,lu-2,4,64),new Ii({color:1976635,roughness:.9,metalness:.2}));fu.position.y=-2.25,ru.add(fu);var pu=new Xr(new Si(lu,lu,.5,64),new Ii({map:uu,bumpMap:uu,bumpScale:.05,roughness:.6,metalness:.3}));pu.position.y=-.25,pu.receiveShadow=!0,ru.add(pu);var mu=new Xr(new Ti(lu,.4,32,64),new Ii({color:988970,roughness:.8}));mu.rotation.x=Math.PI/2,ru.add(mu);var hu=new Xr(new Si(4,4,.52,64),new Ii({map:du,bumpMap:du,bumpScale:.02,roughness:.8,metalness:.2}));hu.position.y=-.25,hu.receiveShadow=!0,ru.add(hu);var gu=new wn,_u=new Xr(new Si(1,1.4,1.2,32),new Ii({color:9741240,roughness:.5,metalness:.5}));_u.position.y=.6,_u.castShadow=!0,_u.receiveShadow=!0,gu.add(_u);var vu=new Xr(new Si(1.8,1.8,.2,32),new Ii({color:1976635,roughness:.7}));vu.position.y=1.3,vu.castShadow=!0,vu.receiveShadow=!0,gu.add(vu);var yu=new Xr(new Si(.5,.55,.2,32),new Ii({color:15680580,roughness:.3}));yu.position.y=1.45,gu.add(yu);var bu=new Xr(new wi(.7,32,16,0,Math.PI*2,0,Math.PI/2),new Li({color:8965375,transparent:!0,opacity:.3,roughness:.1,metalness:.1,transmission:.9}));bu.position.y=1.4,gu.add(bu),ru.add(gu);var xu=new wn;ru.add(xu);var Su=Jl?800:2e3,Cu=new Dr,wu=new Float32Array(Su*3);for(let e=0;e<Su;e++)wu[e*3]=(Math.random()-.5)*200,wu[e*3+1]=(Math.random()-.5)*200,wu[e*3+2]=(Math.random()-.5)*200;Cu.setAttribute(`position`,new fr(wu,3));var Tu=new pi(Cu,new ci({color:16777215,size:.2,transparent:!0,opacity:.8}));Kl.add(Tu);var Eu=new va(16777215,.5);Kl.add(Eu);var Du=new _a(16777215,1.4);Du.position.set(15,30,10),Du.castShadow=!0,Du.shadow.mapSize.width=Jl?512:2048,Du.shadow.mapSize.height=Jl?512:2048,Du.shadow.camera.near=.5,Du.shadow.camera.far=100,Du.shadow.camera.left=-30,Du.shadow.camera.right=30,Du.shadow.camera.top=30,Du.shadow.camera.bottom=-30,Du.shadow.bias=-.001,Kl.add(Du);var Ou=new _a(9741240,.5);Ou.position.set(-15,10,-20),Kl.add(Ou);var ku=new Dr,Au=new Float32Array(zl*10*3),ju=new Float32Array(zl*10),Mu=new Float32Array(zl*10*3);ku.setAttribute(`position`,new fr(Au,3)),ku.setAttribute(`alpha`,new fr(ju,1));var Nu=new pi(ku,new Pi({vertexShader:`
  ...
  `,transparent:!0,blending:1,depthWrite:!1}));ru.add(Nu);var Pu=Array.from({length:zl},()=>({active:!1,t:0}));function Fu(e){let t=Pu[e];t.active=!0,t.t=0;let n=iu[e],r=n.group.position.x,i=n.group.position.y+1,a=n.group.position.z;for(let t=0;t<10;t++){let n=e*10+t;Au[n*3]=r+(Math.random()-.5)*1,Au[n*3+1]=i+(Math.random()-.5)*1,Au[n*3+2]=a+(Math.random()-.5)*1,Mu[n*3]=(Math.random()-.5)*.1,Mu[n*3+1]=Math.random()*.1,Mu[n*3+2]=(Math.random()-.5)*.1,ju[n]=1}}var $={current:-1,transitioning:!1,explore:!1},Iu=[{p:[0,10,45],l:[0,0,0],fov:40},{p:[15,20,15],l:[0,0,0],fov:45},{p:[-15,15,25],l:[0,0,0],fov:40},{p:[22,12,18],l:[0,0,0],fov:45},{p:[-22,6,15],l:[0,2,0],fov:40},{p:[0,5,30],l:[0,2,0],fov:40},{p:[0,12,16],l:[0,0,0],fov:60},{p:[18,18,-18],l:[0,0,0],fov:45},{p:[0,10,32],l:[0,0,0],fov:45},{p:[0,2,20],l:[0,40,0],fov:80},{p:[0,18,30],l:[0,0,0],fov:50}],Lu=!1;function Ru(){Lu=!1,iu.forEach(e=>{e.lifeTimer&&=(e.lifeTimer.kill(),null)})}function zu(e){let t=(Math.random()>.5?1:-1)*(.5+Math.random()*1.4);gsap.to(e.group.rotation,{y:`+=`+t,duration:.28+Math.random()*.2,ease:`sine.inOut`,yoyo:!0,repeat:1})}function Bu(e){let t=e.bobAmp*2.5;gsap.to(e.group.position,{y:`+=`+t,duration:.16,ease:`power2.out`,yoyo:!0,repeat:1}),gsap.to(e.legL.position,{y:.55,duration:.16,ease:`power1.out`,yoyo:!0,repeat:1}),gsap.to(e.legR.position,{y:.55,duration:.16,ease:`power1.out`,yoyo:!0,repeat:1})}function Vu(e){let t=e.personality===`hyper`?5:2;gsap.to(e.legL.position,{z:.28,y:.45,duration:.11,ease:`sine.inOut`,yoyo:!0,repeat:t*2}),gsap.to(e.legR.position,{z:-.28,y:.45,duration:.11,ease:`sine.inOut`,yoyo:!0,repeat:t*2,delay:.11})}function Hu(e){let t=Math.random()>.5?1:-1,n=e.personality===`hyper`?2:1;gsap.to(e.group.rotation,{y:`+=`+t*Math.PI*2*n,duration:.28+Math.random()*.35,ease:`power1.inOut`})}function Uu(e){let t=e.personality===`nervous`?.15:.07;gsap.fromTo(e.group.rotation,{z:-t},{z:t,duration:.055,repeat:6,yoyo:!0,ease:`none`})}function Wu(e){let t=e.swayAmp*(1.5+Math.random());gsap.to(e.group.rotation,{z:(Math.random()>.5?1:-1)*t,duration:.55,ease:`sine.inOut`,yoyo:!0,repeat:1})}function Gu(e){let t=Math.random();switch(e.personality){case`hyper`:return t<.28?`spin`:t<.52?`jump`:t<.72?`wiggle`:t<.88?`look`:`sway`;case`nervous`:return t<.38?`tremble`:t<.62?`look`:t<.78?`jump`:`sway`;case`curious`:return t<.42?`look`:t<.62?`wiggle`:t<.78?`jump`:t<.9?`spin`:`sway`;case`proud`:return t<.32?`spin`:t<.58?`sway`:t<.76?`look`:`jump`;default:return t<.44?`look`:t<.64?`sway`:t<.8?`wiggle`:`jump`}}function Ku(e){let t={hyper:.6,nervous:1.1,curious:1.7,proud:2.4,chill:3.2}[e.personality]||2;return t+Math.random()*t}function qu(e){if(Lu){if(e.match&&!$.transitioning){let t=Gu(e);t===`spin`?Hu(e):t===`jump`?Bu(e):t===`wiggle`?Vu(e):t===`look`?zu(e):t===`tremble`?Uu(e):Wu(e)}e.lifeTimer=gsap.delayedCall(Ku(e),()=>qu(e))}}function Ju(e=0){Lu=!0,iu.forEach(t=>{let n=e+t.idx*.07+Math.random()*Ku(t)*.4;t.lifeTimer=gsap.delayedCall(n,()=>qu(t))})}var Yu=!1;function Xu(){Yu=!1,iu.forEach(e=>{e.wanderTimer&&=(e.wanderTimer.kill(),null),e.wanderMoveTween&&=(e.wanderMoveTween.kill(),null),e.wanderLegL&&=(e.wanderLegL.kill(),null),e.wanderLegR&&=(e.wanderLegR.kill(),null)})}function Zu(e,t){if(!Yu||!e.match){e.wanderTimer=gsap.delayedCall(.8+Math.random(),()=>Zu(e,t));return}let n=Math.random()*Math.PI*2,r=(.25+Math.random()*.75)*t.radius,i=e.baseX+Math.cos(n)*r,a=e.baseZ+Math.sin(n)*r,o=lu-3.5,s=Math.sqrt(i*i+a*a);s>o&&(i*=o/s,a*=o/s);let c=Math.sqrt(i*i+a*a);c<3.5&&(i*=3.5/c,a*=3.5/c);let l=i-e.group.position.x,u=a-e.group.position.z,d=Math.sqrt(l*l+u*u);if(d<.5){e.wanderTimer=gsap.delayedCall(.5+Math.random()*1.5,()=>Zu(e,t));return}let f=Math.max(.6,d/t.speed);if(t.faceDir&&gsap.to(e.group.rotation,{y:Math.atan2(l,u),duration:.25,ease:`power2.out`,overwrite:`auto`}),t.animateLegs){let t=.09+1/e.bobFreq*.07;e.wanderLegL&&e.wanderLegL.kill(),e.wanderLegR&&e.wanderLegR.kill(),e.wanderLegL=gsap.fromTo(e.legL.position,{z:.24,y:.2},{z:-.12,y:.44,duration:t,yoyo:!0,repeat:-1,ease:`sine.inOut`}),e.wanderLegR=gsap.fromTo(e.legR.position,{z:-.24,y:.2},{z:.12,y:.44,duration:t,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:t})}e.wanderMoveTween=gsap.to(e.group.position,{x:i,z:a,duration:f,ease:`sine.inOut`,overwrite:`auto`,onComplete:()=>{if(!Yu)return;t.animateLegs&&(e.wanderLegL&&=(e.wanderLegL.kill(),null),e.wanderLegR&&=(e.wanderLegR.kill(),null),gsap.to(e.legL.position,{z:0,y:.2,duration:.15}),gsap.to(e.legR.position,{z:0,y:.2,duration:.15}));let n=.3+Math.random()*(t.pauseMax??2.5);e.wanderTimer=gsap.delayedCall(n,()=>Zu(e,t))}})}function Qu(e={}){let t={radius:e.radius??7,speed:e.speed??2.8,animateLegs:e.animateLegs??!0,faceDir:e.faceDir??!0,initialDelay:e.initialDelay??0,pauseMax:e.pauseMax??2.5};Yu=!0,iu.forEach(e=>{let n=t.initialDelay+Math.random()*2;e.wanderTimer=gsap.delayedCall(n,()=>Zu(e,t))})}function $u(e){Ru(),Xu(),gsap.killTweensOf(ru.rotation),gsap.to(ru.rotation,{y:0,duration:2.5,ease:`power3.inOut`}),iu.forEach(t=>{gsap.killTweensOf(t.group.position),gsap.killTweensOf(t.group.rotation),gsap.killTweensOf(t.group.scale),gsap.killTweensOf(t.suitMat.color),gsap.killTweensOf(t.legL.position),gsap.killTweensOf(t.legR.position),gsap.killTweensOf(t.bodyMesh.position),t.suitMat.color.setHex(t.baseHex),t.visorMat.color.setHex(8965375),!$.explore&&t.match&&(gsap.to(t.suitMat,{opacity:1,duration:1}),gsap.to(t.visorMat,{opacity:1,duration:1}),gsap.to(t.group.scale,{x:t.baseScale,y:t.baseScale,z:t.baseScale,duration:1,ease:`power2.out`}),gsap.to(t.group.rotation,{x:0,y:0,z:0,duration:1,ease:`power2.out`}),gsap.to(t.legL.position,{y:.2,z:0,duration:.5}),gsap.to(t.legR.position,{y:.2,z:0,duration:.5}),gsap.to(t.bodyMesh.position,{y:.7,duration:.5}),e!==0&&e!==9&&gsap.to(t.group.position,{x:t.baseX,y:t.baseY,z:t.baseZ,duration:1.5,ease:`power2.inOut`}))}),xu.children.forEach(e=>gsap.to(e.material,{opacity:0,duration:.5})),e===0?(iu.forEach(e=>{e.group.position.y=-15;let t={hyper:`back.out(2.5)`,nervous:`elastic.out(1,0.4)`,curious:`back.out(1.8)`,proud:`power4.out`,chill:`back.out(1.2)`},n={hyper:1.8,nervous:2.8,curious:2.4,proud:2,chill:3}[e.personality]||2.5;gsap.to(e.group.position,{x:e.baseX,y:e.baseY,z:e.baseZ,duration:n,ease:t[e.personality]||`back.out(1.5)`,delay:e.idx*.04})}),gsap.delayedCall(3.2,()=>{Ju(0),Qu({radius:12,speed:1.8,animateLegs:!0,faceDir:!0,pauseMax:3.5})})):e===1?(Qu({radius:10,speed:3,animateLegs:!1,faceDir:!0,initialDelay:.6,pauseMax:1.5}),iu.forEach(e=>{let t=.08+1/e.bobFreq*.14,n=.18+e.bobAmp*.28,r=e.bobAmp*.45,i=e.swayAmp*.8,a=Math.random()*.3;gsap.fromTo(e.legL.position,{y:.2,z:.1},{z:n,y:.42,duration:t,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:a}),gsap.fromTo(e.legR.position,{y:.2,z:-.1},{z:-n,y:.42,duration:t,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:a+t}),gsap.fromTo(e.bodyMesh.position,{y:.7},{y:.7+r,duration:t,yoyo:!0,repeat:-1,ease:`sine.inOut`}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+r*.7,duration:t*2,yoyo:!0,repeat:-1,ease:`sine.inOut`}),e.personality===`hyper`?gsap.fromTo(e.group.rotation,{z:-i},{z:i,duration:t,yoyo:!0,repeat:-1}):e.personality===`nervous`&&gsap.fromTo(e.group.rotation,{y:-.3},{y:.3,duration:t*3,yoyo:!0,repeat:-1})})):e===2?(gsap.delayedCall(1.2,()=>Qu({radius:5,speed:1.2,animateLegs:!1,faceDir:!1,pauseMax:4})),iu.forEach(e=>{let t=Math.atan2(e.baseX,e.baseZ);gsap.to(e.group.rotation,{y:t+Math.PI,duration:.8+e.swayAmp*4,ease:`power2.out`}),e.personality===`curious`?gsap.fromTo(e.group.rotation,{x:0},{x:.35,duration:.25,yoyo:!0,repeat:-1,delay:Math.random()*1.5,ease:`sine.inOut`}):e.personality===`nervous`?gsap.fromTo(e.group.rotation,{x:0},{x:.2,duration:.2,yoyo:!0,repeat:-1,delay:Math.random(),ease:`sine.inOut`}):gsap.fromTo(e.group.rotation,{x:0},{x:.15,duration:.4,yoyo:!0,repeat:-1,delay:Math.random()*2.5,ease:`sine.inOut`})}),gsap.delayedCall(2.5,()=>Ju(0))):e===3?(gsap.fromTo(ru.rotation,{y:0},{y:Math.PI*2,duration:20,ease:`none`,repeat:-1}),iu.forEach(e=>{let t=1/e.bobFreq*1.2+.4,n=e.bobAmp*3.5,r=.25+e.bobAmp*.3,i=.2+e.bobAmp*.2;gsap.fromTo(e.group.rotation,{y:0},{y:Math.PI*2,duration:t,repeat:-1,ease:`none`}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+n,duration:r,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:Math.random()}),gsap.fromTo(e.legL.position,{x:-.15,y:.2},{y:.55,x:-i,duration:r,yoyo:!0,repeat:-1,delay:Math.random()}),gsap.fromTo(e.legR.position,{x:.15,y:.2},{y:.55,x:i,duration:r,yoyo:!0,repeat:-1,delay:Math.random()})})):e===4?(gsap.delayedCall(2,()=>Qu({radius:8,speed:1.6,animateLegs:!0,faceDir:!0,pauseMax:3})),iu.forEach(e=>{let t=Rl[e.idx].sen>=2,n=Rl[e.idx].sen===0;t?(gsap.to(e.group.scale,{x:e.baseScale*1.6,y:e.baseScale*1.8,z:e.baseScale*1.6,duration:1.5,ease:`elastic.out(1, 0.5)`}),gsap.delayedCall(1.8,()=>{gsap.fromTo(e.group.rotation,{z:-e.swayAmp},{z:e.swayAmp,duration:1.2,yoyo:!0,repeat:-1,ease:`sine.inOut`})})):n?(gsap.to(e.group.scale,{x:e.baseScale*.6,y:e.baseScale*.5,z:e.baseScale*.6,duration:1.5,ease:`power2.out`}),gsap.delayedCall(1.5,()=>{gsap.fromTo(e.group.rotation,{z:-.08},{z:.08,duration:.06,yoyo:!0,repeat:-1,ease:`none`})})):gsap.delayedCall(1,()=>{gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+e.bobAmp,duration:.5/e.bobFreq,yoyo:!0,repeat:-1,ease:`sine.inOut`})})})):e===5?(Qu({radius:7,speed:1.5,animateLegs:!1,faceDir:!1,initialDelay:.5,pauseMax:2}),iu.forEach(e=>{let t=.35+e.bobAmp*.2,n=e.bobAmp*2.8,r=Math.random();e.personality===`hyper`?(gsap.fromTo(e.group.rotation,{y:0},{y:Math.PI*2,duration:.45,repeat:-1,ease:`none`}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+n*1.6,duration:t*.45,yoyo:!0,repeat:-1,ease:`power2.out`,delay:r}),gsap.fromTo(e.legL.position,{z:-.25,y:.2},{z:.35,y:.55,duration:.13,yoyo:!0,repeat:-1}),gsap.fromTo(e.legR.position,{z:.25,y:.2},{z:-.35,y:.55,duration:.13,yoyo:!0,repeat:-1,delay:.13})):e.personality===`chill`?(gsap.fromTo(e.group.rotation,{z:-.28},{z:.28,duration:t*2.2,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:r}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+n*.5,duration:t*1.1,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:r}),gsap.fromTo(e.legL.position,{z:.12,y:.22},{z:-.12,y:.32,duration:t*.9,yoyo:!0,repeat:-1,delay:r}),gsap.fromTo(e.legR.position,{z:-.12,y:.22},{z:.12,y:.32,duration:t*.9,yoyo:!0,repeat:-1,delay:r+t*.45})):e.personality===`nervous`?(gsap.fromTo(e.group.rotation,{y:-Math.PI/3},{y:Math.PI/3,duration:.28,yoyo:!0,repeat:-1,ease:`steps(2)`}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+n,duration:.28,yoyo:!0,repeat:-1,ease:`steps(1)`,delay:r}),gsap.fromTo(e.legL.position,{y:.2,x:-.15},{y:.52,x:-.15,duration:.28,yoyo:!0,repeat:-1}),gsap.fromTo(e.legR.position,{y:.52,x:.15},{y:.2,x:.15,duration:.28,yoyo:!0,repeat:-1})):e.personality===`curious`?(gsap.fromTo(e.group.rotation,{y:-1},{y:1,duration:t*1.4,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:r}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+n*.9,duration:t*.6,yoyo:!0,repeat:-1,ease:`power1.out`,delay:r}),gsap.fromTo(e.legL.position,{z:.22,y:.2},{z:-.08,y:.42,duration:t*.55,yoyo:!0,repeat:-1,delay:r}),gsap.fromTo(e.legR.position,{z:-.22,y:.2},{z:.08,y:.42,duration:t*.55,yoyo:!0,repeat:-1,delay:r+t*.28})):(gsap.fromTo(e.group.rotation,{x:-.18},{x:.08,duration:t*.7,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:r}),gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+n*1.1,duration:t*.55,yoyo:!0,repeat:-1,ease:`power2.out`,delay:r}),gsap.fromTo(e.legL.position,{z:.32,y:.2,x:-.15},{z:-.08,y:.55,x:-.15,duration:t*.55,yoyo:!0,repeat:-1,delay:r}),gsap.fromTo(e.legR.position,{z:-.32,y:.2,x:.15},{z:.08,y:.55,x:.15,duration:t*.55,yoyo:!0,repeat:-1,delay:r+t*.28}))})):e===6?iu.forEach(e=>{let t=Math.atan2(e.baseX,e.baseZ)+Math.PI;gsap.to(e.group.rotation,{y:t,duration:.4,ease:`power2.out`});let n=Math.sqrt(e.baseX*e.baseX+e.baseZ*e.baseZ),r=Math.max(.15,(n-2.5)/n),i=e.baseX*r,a=e.baseZ*r,o=e.bobAmp*1.5,s={hyper:.18,nervous:.35,curious:.25,proud:.22,chill:.45}[e.personality]||.3,c=s*2.2,l=.1+Math.random()*.4,u=gsap.timeline({repeat:-1,delay:Math.random()*1.5});u.to(e.group.rotation,{x:-.55,duration:s*.4,ease:`power2.in`}),u.to(e.group.position,{x:i,z:a,y:e.baseY+o,duration:s,ease:`power3.in`},`<`),u.to(e.legL.position,{z:.32,y:.48,duration:s*.5,yoyo:!0,repeat:1,ease:`sine.inOut`},`<`),u.to(e.legR.position,{z:-.32,y:.48,duration:s*.5,yoyo:!0,repeat:1,ease:`sine.inOut`,delay:s*.25},`<`),u.to(e.group.position,{x:e.baseX,z:e.baseZ,y:e.baseY,duration:c,ease:`elastic.out(1, 0.4)`}),u.to(e.group.rotation,{x:.2,duration:c*.3,ease:`power1.out`},`<`),u.to(e.group.rotation,{x:0,duration:c*.7,ease:`sine.inOut`}),u.to(e.group.rotation,{z:(Math.random()>.5?1:-1)*.15,duration:l*.5,yoyo:!0,repeat:1})}):e===7?(Qu({radius:7,speed:2.2,animateLegs:!1,faceDir:!0,initialDelay:.8,pauseMax:2}),iu.forEach(e=>{if(e.isMetricsUser){let t=e.bobAmp*2.8,n=.28+1/e.bobFreq*.22;gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+t,duration:n,yoyo:!0,repeat:-1,ease:`power2.out`,delay:Math.random()*.5}),gsap.fromTo(e.legL.position,{y:.2},{y:.55+e.bobAmp,duration:n,yoyo:!0,repeat:-1}),gsap.fromTo(e.legR.position,{y:.2},{y:.55+e.bobAmp,duration:n,yoyo:!0,repeat:-1,delay:n*.5}),(e.personality===`hyper`||e.personality===`proud`)&&gsap.to(e.group.rotation,{y:`+=`+Math.PI*2,duration:.8,repeat:-1,ease:`none`,delay:Math.random()*2})}else{e.suitMat.transparent=!0,e.visorMat.transparent=!0;function t(){if($.current!==7)return;let n=1.2+Math.random()*2.8,r=.4+Math.random()*1.6,i={hyper:.15,nervous:.35,chill:.5,curious:.25,proud:.2}[e.personality]||.3,a=i*1.6;gsap.delayedCall(n,()=>{$.current===7&&(Fu(e.idx),gsap.to(e.group.scale,{x:0,y:0,z:0,duration:i,ease:`back.in(1.8)`,onComplete:()=>{$.current===7&&gsap.delayedCall(r,()=>{$.current===7&&gsap.to(e.group.scale,{x:e.baseScale,y:e.baseScale,z:e.baseScale,duration:a,ease:`elastic.out(1.3, 0.45)`,onComplete:t})})}}))})}gsap.delayedCall(Math.random()*3.5,t),gsap.fromTo(e.group.rotation,{z:-e.swayAmp},{z:e.swayAmp,duration:.4+e.bobAmp*.4,yoyo:!0,repeat:-1,ease:`sine.inOut`})}})):e===8?iu.forEach((e,t)=>{let n=Rl[t],r=.4+e.bobAmp*.4;if(n.ia_pos&&n.fear_subst)gsap.to(e.suitMat.color,{r:.6,g:.2,b:.8,duration:1.5}),gsap.fromTo(e.group.rotation,{y:-1},{y:1,duration:r,yoyo:!0,repeat:-1,ease:`sine.inOut`,delay:Math.random()});else if(n.ia_pos){gsap.to(e.suitMat.color,{r:.1,g:.8,b:.3,duration:1.5});let t=3+e.bobAmp*2;gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+t,duration:1.5+e.bobAmp,yoyo:!0,repeat:-1,ease:`sine.inOut`}),gsap.to(e.group.rotation,{x:-.4-e.swayAmp,duration:1.5}),e.personality===`hyper`&&gsap.fromTo(e.group.rotation,{z:-.2},{z:.2,duration:.3,yoyo:!0,repeat:-1})}else if(n.fear_subst){gsap.to(e.suitMat.color,{r:.9,g:.1,b:.1,duration:1.5});let t=e.personality===`nervous`?.04:.07;gsap.fromTo(e.group.position,{x:e.baseX-.25},{x:e.baseX+.25,duration:t,yoyo:!0,repeat:-1}),gsap.fromTo(e.group.rotation,{z:-.08},{z:.08,duration:t*1.5,yoyo:!0,repeat:-1})}}):e===9?iu.forEach(e=>{let t=8+e.bobAmp*15,n=35+e.bobAmp*25,r={hyper:6,nervous:12,curious:8,proud:7,chill:15}[e.personality]||10,i=(Math.random()-.5)*t,a=(Math.random()-.5)*t,o=e.personality===`hyper`?Math.random()*Math.PI*20:Math.random()*Math.PI*6,s=e.personality===`nervous`?Math.random()*Math.PI*3:Math.random()*Math.PI*12,c=Math.random()*Math.PI*8;gsap.fromTo(e.group.position,{x:e.baseX,y:e.baseY,z:e.baseZ},{x:e.baseX+i,y:e.baseY+n,z:e.baseZ+a,duration:r,ease:`power1.out`}),gsap.to(e.group.rotation,{x:o,y:s,z:c,duration:r,ease:`none`})}):e===10&&(gsap.fromTo(ru.rotation,{y:0},{y:Math.PI*2,duration:20,ease:`none`,repeat:-1}),iu.forEach(e=>{let t=e.bobAmp*4,n=.18+1/e.bobFreq*.25,r=e.personality===`hyper`?.4:e.personality===`chill`?1.5:.9;gsap.fromTo(e.group.position,{y:e.baseY},{y:e.baseY+t,duration:n,yoyo:!0,repeat:-1,delay:Math.random()*.4,ease:`power2.out`}),gsap.to(e.group.rotation,{y:`+=`+Math.PI*2,duration:r,repeat:-1,ease:`none`}),gsap.fromTo(e.legL.position,{y:.2},{y:.6+e.bobAmp,duration:n,yoyo:!0,repeat:-1}),gsap.fromTo(e.legR.position,{y:.2},{y:.6+e.bobAmp,duration:n,yoyo:!0,repeat:-1,delay:n*.5}),e.personality===`hyper`&&gsap.fromTo(e.group.rotation,{z:-.3},{z:.3,duration:.2,yoyo:!0,repeat:-1})}))}function ed(e){let t=e.querySelectorAll(`.line-anim`);gsap.fromTo(t,{opacity:0,y:15},{opacity:1,y:0,duration:.8,stagger:.05,ease:`power2.out`,clearProps:`transform`}),e.querySelectorAll(`.stat-val, .paradox-num`).forEach(e=>{let t=parseFloat(e.dataset.target);gsap.fromTo(e,{innerHTML:0},{innerHTML:t,duration:1.5,ease:`power2.out`,snap:{innerHTML:.1},onUpdate:function(){e.innerHTML=Number(this.targets()[0].innerHTML).toFixed(1)}})}),e.querySelectorAll(`.ch-bar-row`).forEach(e=>{let t=e.querySelector(`.bar-fill`),n=parseFloat(e.dataset.pct);gsap.fromTo(t,{width:`0%`},{width:n+`%`,duration:1.2,ease:`power2.out`,delay:.2})})}var td=new K(0,0,0);function nd(e){if($.transitioning||e===$.current)return;if(e<0||e>=Bl){e>=Bl&&od();return}$.transitioning=!0;let t=$.current,n=e,r=document.querySelectorAll(`.chapter`);document.getElementById(`ch-label`).textContent=Vl[n];let i=gsap.timeline({onComplete:()=>{$.current=n,$.transitioning=!1,document.querySelectorAll(`.dot`).forEach((e,t)=>e.classList.toggle(`active`,t===n)),document.getElementById(`arrow-prev`).disabled=n===0,document.getElementById(`arrow-next`).disabled=!1}});t>=0&&r[t]&&(i.to(r[t],{opacity:0,duration:.4,ease:`power2.inOut`},0),i.set(r[t],{pointerEvents:`none`},0));let a=Iu[n];i.to(ql.position,{x:a.p[0],y:a.p[1],z:a.p[2],duration:2,ease:`power2.inOut`},0),i.to(td,{x:a.l[0],y:a.l[1],z:a.l[2],duration:2,ease:`power2.inOut`,onUpdate:()=>ql.lookAt(td)},0),i.to(ql,{fov:a.fov,duration:2,ease:`power2.inOut`,onUpdate:()=>ql.updateProjectionMatrix()},0);let o=t===-1?.2:1.6;i.set(r[n],{pointerEvents:`auto`},o),i.to(r[n],{opacity:1,duration:.8,ease:`power2.out`,onStart:()=>ed(r[n])},o),i.to({},{duration:.1,onUpdate:()=>document.getElementById(`prog-fill`).style.width=n/(Bl-1)*100+`%`},0),document.getElementById(`arrow-prev`).disabled=!0,document.getElementById(`arrow-next`).disabled=!0,$u(n)}document.getElementById(`btn-iniciar`).addEventListener(`click`,()=>nd(1)),document.getElementById(`arrow-prev`).addEventListener(`click`,()=>nd($.current-1)),document.getElementById(`arrow-next`).addEventListener(`click`,()=>nd($.current+1)),document.addEventListener(`keydown`,e=>{$.explore||((e.key===`ArrowRight`||e.key===` `)&&(e.preventDefault(),nd($.current+1)),e.key===`ArrowLeft`&&(e.preventDefault(),nd($.current-1)),(e.key===`e`||e.key===`E`)&&od())});var rd=0,id=0,ad=0;document.addEventListener(`touchstart`,e=>{rd=e.touches[0].clientX,id=e.touches[0].clientY,ad=Date.now()},{passive:!0}),document.addEventListener(`touchend`,e=>{if($.explore)return;let t=e.changedTouches[0].clientX-rd,n=e.changedTouches[0].clientY-id,r=Date.now()-ad;Math.abs(t)>Math.abs(n)&&Math.abs(t)>50&&r<400&&nd(t<0?$.current+1:$.current-1)},{passive:!0}),document.querySelectorAll(`.dot`).forEach(e=>e.addEventListener(`click`,()=>nd(parseInt(e.dataset.ch))));function od(){$.explore||($.explore=!0,$.transitioning=!1,gsap.killTweensOf(ql.position),gsap.killTweensOf(td),gsap.killTweensOf(ru.rotation),iu.forEach(e=>{e.suitMat.color.setHex(e.baseHex),e.visorMat.color.setHex(8965375),gsap.to(e.suitMat,{opacity:1,duration:1}),gsap.to(e.visorMat,{opacity:1,duration:1}),gsap.to(e.group.position,{x:e.baseX,y:e.baseY,z:e.baseZ,duration:1.5,ease:`power2.out`,onComplete:()=>{gsap.to(e.group.position,{y:e.baseY+.3,duration:1.5,yoyo:!0,repeat:-1,ease:`sine.inOut`})}})}),Xl.enabled=!0,Xl.target.copy(td),gsap.to(`#overlay`,{opacity:0,duration:.5,onComplete:()=>document.getElementById(`overlay`).style.display=`none`}),gsap.to(`#nav-arrows`,{opacity:0,duration:.3,onComplete:()=>document.getElementById(`nav-arrows`).style.display=`none`}),gsap.to(`#prog-bar`,{opacity:0,duration:.3,onComplete:()=>document.getElementById(`prog-bar`).style.display=`none`}),document.getElementById(`ch-label`).textContent=`EXPLORE`,document.getElementById(`sidebar-toggle`).style.display=`flex`,document.getElementById(`sidebar`).classList.add(`open`),document.getElementById(`sidebar-toggle`).classList.add(`open`),gsap.to(ql.position,{x:0,y:20,z:35,duration:2,ease:`power2.out`}),gsap.to(td,{x:0,y:0,z:0,duration:2,ease:`power2.out`,onUpdate:()=>ql.lookAt(td)}),gsap.to(ql,{fov:45,duration:2,onUpdate:()=>ql.updateProjectionMatrix()}),gsap.to(ru.rotation,{y:0,duration:2}))}var sd=[{id:`origem`,label:`I · ORIGEM`,filters:{foco:{label:`FOCO`,values:[`Back-end`,`Full-stack`,`Mobile`,`Front-end`,`Dados`,`QA`]}}},{id:`prof`,label:`II · PROFISSIONAL`,filters:{sen:{label:`SENIORIDADE`,values:[`0`,`1`,`2`,`3`]},emp:{label:`STATUS`,values:[`empregado`,`ja_atuou`,`primeiro_emprego`]}}},{id:`stacks`,label:`III · STACKS`,filters:{stacks:{label:`TECNOLOGIA`,values:[`JS/TS`,`Python`,`Java`,`C#/.NET`,`SQL/BD`,`Cloud`,`Kotlin/Swift`,`Go`]}}},{id:`ia`,label:`IV · IA & FUTURO`,filters:{ia:{label:`RELAÇÃO COM IA`,values:[`impacto_positivo`,`medo_substituicao`]},obj:{label:`OBJETIVO`,values:[`exterior`,`migrar`,`promocao`,`empreender`]}}}],cd={foco:new Set,sen:new Set,stacks:new Set,obj:new Set,ia:new Set,emp:new Set,anyActive:!1},ld={exterior:`Exterior`,migrar:`Migrar`,promocao:`Promoção`,empreender:`Empreender`,primeiro_emprego:`1º Emprego`,impacto_positivo:`Impacto +`,medo_substituicao:`Medo Subst.`,empregado:`Empregado`,ja_atuou:`Já Atuou`},ud=[`Estágio`,`Júnior`,`Pleno`,`Sênior`];function dd(e){let t=Rl[e];if(cd.foco.size>0&&!cd.foco.has(t.foco)||cd.sen.size>0&&!cd.sen.has(String(t.sen))||cd.emp.size>0&&!cd.emp.has(t.emp)||cd.stacks.size>0&&!t.stacks.some(e=>cd.stacks.has(e))||cd.obj.size>0&&!cd.obj.has(t.obj))return!1;if(cd.ia.size>0){let e=!1;if(cd.ia.has(`impacto_positivo`)&&t.ia_pos&&(e=!0),cd.ia.has(`medo_substituicao`)&&t.fear_subst&&(e=!0),!e)return!1}return!0}function fd(){cd.anyActive=[`foco`,`sen`,`stacks`,`obj`,`ia`,`emp`].some(e=>cd[e].size>0);let e=0;for(let t=0;t<zl;t++){let n=cd.anyActive?dd(t):!0,r=iu[t];n!==r.match&&(n?gsap.to(r.group.scale,{x:r.baseScale,y:r.baseScale,z:r.baseScale,duration:.8,ease:`elastic.out(1, 0.5)`}):(Fu(t),gsap.to(r.group.scale,{x:0,y:0,z:0,duration:.5,ease:`back.in(1.5)`})),r.match=n),n&&e++}document.getElementById(`filter-info`).textContent=cd.anyActive?`[ ${e}/${zl} CREWMATES ]`:`[ ${zl} CREWMATES ]`}function pd(){let e=document.getElementById(`sidebar-content`),t=document.createElement(`div`);t.id=`sb-tabs`,e.appendChild(t);let n=document.createElement(`div`);n.id=`sb-panels`,e.appendChild(n),sd.forEach((e,r)=>{let i=document.createElement(`button`);i.className=`sb-tab`+(r===0?` active`:``),i.textContent=e.label,t.appendChild(i);let a=document.createElement(`div`);a.className=`sb-panel`+(r===0?` visible`:``),n.appendChild(a),Object.entries(e.filters).forEach(([e,t])=>{let n=document.createElement(`h3`);n.textContent=t.label,a.appendChild(n);let r=document.createElement(`div`);r.className=`fgroup`,t.values.forEach(t=>{let n=document.createElement(`button`);n.className=`fbtn`,n.textContent=e===`sen`?ud[parseInt(t)]:ld[t]||t,n.addEventListener(`click`,()=>{cd[e].has(t)?(cd[e].delete(t),n.classList.remove(`active`)):(cd[e].add(t),n.classList.add(`active`)),fd()}),r.appendChild(n)}),a.appendChild(r)}),i.addEventListener(`click`,()=>{t.querySelectorAll(`.sb-tab`).forEach((e,t)=>e.classList.toggle(`active`,t===r)),n.querySelectorAll(`.sb-panel`).forEach((e,t)=>e.classList.toggle(`visible`,t===r))})});let r=document.createElement(`button`);r.className=`fclear`,r.textContent=`Limpar Filtros`,r.addEventListener(`click`,()=>{e.querySelectorAll(`.fbtn`).forEach(e=>e.classList.remove(`active`)),[`foco`,`sen`,`stacks`,`obj`,`ia`,`emp`].forEach(e=>cd[e].clear()),fd()}),e.appendChild(r);let i=document.createElement(`div`);i.className=`filter-info`,i.id=`filter-info`,e.appendChild(i)}pd(),document.getElementById(`sidebar-toggle`).addEventListener(`click`,e=>{let t=document.getElementById(`sidebar`);e.currentTarget.classList.toggle(`open`),t.classList.toggle(`open`)});function md(e){requestAnimationFrame(md);let t=e*.001;$.current===8&&!$.transitioning&&!$.explore&&(ru.rotation.y=t*.1),Tu.rotation.y=t*.02;let n=!1;for(let e=0;e<zl;e++){let t=Pu[e];if(t.active){t.t+=.03,n=!0;for(let n=0;n<10;n++){let r=e*10+n;Au[r*3]+=Mu[r*3],Au[r*3+1]+=Mu[r*3+1]+.02,Au[r*3+2]+=Mu[r*3+2],ju[r]=Math.max(0,1-t.t*1.5)}t.t>1&&(t.active=!1)}}n&&(ku.attributes.position.needsUpdate=!0,ku.attributes.alpha.needsUpdate=!0),Xl.enabled&&Xl.update(),Zl.render()}md(0),setTimeout(()=>nd(0),100),window.addEventListener(`resize`,()=>{ql.aspect=innerWidth/innerHeight,ql.updateProjectionMatrix(),Yl.setSize(innerWidth,innerHeight),Zl.setSize(innerWidth,innerHeight)});